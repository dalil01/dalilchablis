...
export class dcOffice extends dcView {
	...
	private constructor(parentElement: HTMLElement, mainElement: HTMLElement, autoInit: boolean = false) {
		...
		this.HTMLContainer = _UDom.div({ className: OFFICE_CSS_CLASSNAMES.HTML_CONTAINER });
	...
	private buildStartVisitButton(): void {
		const startVisitContainer = _UDom.div({ className: OFFICE_CSS_CLASSNAMES.START_VISIT_CONTAINER });
