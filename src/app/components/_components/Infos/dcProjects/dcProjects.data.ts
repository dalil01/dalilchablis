...
const placeholderPath: Promise<string> = import((`images/projects/placeholder.webp`));

export class dcProjectsData {

	public static getData(): dcProjectsType[] {
		return [
			{
				$title: "PERSONALS",
				items: [
					{
						imgPath: import((`images/projects/personals/dalilchablis-v2.webp`)),
					...
					{
						imgPath: import((`images/projects/personals/brain.webp`)),
						name: "BrAiN (2020)",
						$description: "BRAIN",
						techStack: "HTML, CSS"
					},
					{
						imgPath: import((`images/projects/personals/plancadeau.webp`)),
						name: "Plancadeau (2019)",
						$description: "IN_DEV",
						techStack: "HTML, CSS, Typescript, Python"
					},
					{
						imgPath: import((`images/projects/personals/mysport.webp`)),
						name: "MySport (2018)",
						$description: "MYSPORT",
						techStack: "HTML, CSS, Javascript, PHP"
					},
					{
						imgPath: import((`images/projects/personals/athletec.webp`)),
						name: "Athletec (2017)",
			...
			},
			{
				...
				items: [
					...
					{
						imgPath: import((`images/projects/professionals/canvas-grid.webp`)),
			...
			},
			{
				...
				items: [
					...
					{
						imgPath: import((`images/projects/academics/redditech.webp`)),
						name: "Redditech (2023)",
						$description: "REDDITECH",
						techStack: "Typescript, React native, Expo, OAuth2, Jest, Docker"
					},
					{
						imgPath: import((`images/projects/academics/tempchat.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/you_shall_not_pass.webp`)),
						name: "You shall not pass (2022)",
						$description: "YOU_SHALL_NOT_PASS",
						techStack: "OpenBSD 7.2, FreeBSD 12/13, DHCP, Paquet filter"
					},
					{
						imgPath: import((`images/projects/academics/epivibes.webp`)),
						name: "EPIVIBES (2022)",
						$description: "EPIVIBES",
						techStack: "Vue.js, Spring boot, Gradle, OAuth2"
					},
					{
						imgPath: import((`images/projects/academics/jobboard.webp`)),
						name: "JobBoard (2022)",
						$description: "JOB_BOARD",
						techStack: "Symfony 6, Angular"
					},
					{
						imgPath: import((`images/projects/academics/data-analyzer.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/blindtest.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/slacklike.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/ibuysu.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/citycar.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/multiplication.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/sparkline.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/guesswhat.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/virtual-landscape.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/geoworld.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/aeroclub-frotey-les-lure.webp`)),
					...
					{
						imgPath: import((`images/projects/academics/boucherie-meme.webp`)),
