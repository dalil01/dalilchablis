...
import { Modal, Modal_TYPE } from "../../_components/dcModal/Modal";
import { dcAboutMe } from "../../_components/Infos/dcAboutMe/dcAboutMe";
import { Contact } from "../../_components/Contact/Contact";
import { dcEducation } from "../../_components/Infos/dcEducation/dcEducation";
import { dcExperience } from "../../_components/Infos/dcExperience/dcExperience";
import { dcProjects } from "../../_components/Infos/dcProjects/dcProjects";
import { dcSkills } from "../../_components/Infos/dcSkills/dcSkills";
...
export class office extends view {
		...
		const gltfPromise = new Promise<void>(async (resolve) => {
			this.gltfLoader.load(Vars.PATH.STUDIO_GLB, (gltf) => {
				...
				for (let i = 0; i < 2; i++) {
					...
					this.scene.add(Vars.isDarkMode ? this.gltfSceneDark : this.gltfSceneLight);
				}
	...
	private animate(): void {
		if (Vars.currentView !== VIEWS.OFFICE) {
			return;
		}
